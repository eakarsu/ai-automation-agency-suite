export const AUTH_COOKIE = 'ai_automation_agency_suite_session';
...
export const demoUsers: DemoUser[] = [
  {
    email: 'admin@ai-automation-agency.local',
    password: 'admin123',
    firstName: 'Suite',
    lastName: 'Admin',
    role: 'admin',
  ...
  {
    email: 'manager@ai-automation-agency.local',
    password: 'manager123',
    firstName: 'Suite',
    lastName: 'Manager',
    role: 'manager',
  ...
  {
    email: 'analyst@ai-automation-agency.local',
    password: 'analyst123',
    firstName: 'Suite',
    lastName: 'Analyst',
    role: 'analyst',
