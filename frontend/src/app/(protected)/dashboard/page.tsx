...
export default function DashboardPage() {
  return (
    <UnifiedShell
      ...
      title="AI Automation Agency Suite Dashboard"
      subtitle="One merged ai automation agency view for Chatbot Builder, Lead Qualification, Appointment Booking, Email Automation, CRM Workflows, WhatsApp/SMS Assistants, Client Workspaces, documents, audit, and AI."
    >
      ...
      <div className="grid columns-2">
        <div className="card stack">
          ...
          <div className="muted">
            This suite removes project-based navigation and groups shared ai automation agency jobs into one surface. Chatbot Builder, Lead Qualification, Appointment Booking, Email Automation, CRM Workflows, WhatsApp/SMS Assistants, Client Workspaces, source tables, documents, audit, and AI are presented as platform features.
          </div>
